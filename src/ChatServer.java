...
public class ChatServer implements Runnable {
	...
	String runRoot= "C:/workspace/MindChat/bin/";  // 사용자님의 맟춰서 SSLSocketServerKey를 만들어주세요
	...
	private ChatServerRunnable clients[] = new ChatServerRunnable[6];
	...
	public void run() {
		try {
			...
			System.out.println("왔? 문제발생 관리자 불러와");
			System.out.println(e);
	...
	public void addClient(SSLServerSocket serverSocket) {
		...
		try {
			...
			if (clientCount < clients.length) { 
				...
				ChatServerRunnable dummyRunnable = new ChatServerRunnable(this, clientSocket);
